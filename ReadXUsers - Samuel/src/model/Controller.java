...
public class Controller {
	...
	public void testCases() {
		...
		products.add(new Libro("4AF", "A Game of Thrones", 694, 19.19,"01/08/1996","Join adventurers across the seven kingdoms", Genre.FANTASIA, "AGOT.png"));
		products.add(new Revista("4AZ", "Vogue", 40,"01/08/1996",4, RevistaCat.VARIEDADES, "LMV2021.jpg","Mensual"));
	...
	public String registerUser(String id, String name, String nickname, int option, int option2) {
		...
		for(int i=0; i<users.size();i++){
                ...
                if(option == 1){
                    ...
                    return "Se ha registrado la armadura";
           		}
        } 
	...
	public boolean registerBook(int optionP, String id, String name, int numPages, int category, String review, int genre, String url, double price, String periodicity, int diaInicio, int mesInicio, int anInicio) {
		...
		for(int i=0; i<users.size();i++){
			...
			if(optionP == 1){
				products.add(new Libro(id, name, numPages, price, fechaChange, review, genreType, url));
				return true;
			}else if(optionP == 2){
				products.add(new Revista(id, name, numPages, fechaChange, price, cat, url, periodicity));
				return true;
			}
		}
	...
	public String sellBook(int t, int i) {
		...
		if(users.get(t) instanceof Premium){
			...
			premium.buyBooksOrSubscribe(producto, id, name1, numPages, price, publicationDate, review, genre, url,revistaCat, peridiocity);
		...
		if(users.get(t) instanceof Regular){
			...
			regular.buyBooksOrSubscribe(producto, id, name1, numPages, price, publicationDate, review, genre, url,revistaCat, peridiocity);
